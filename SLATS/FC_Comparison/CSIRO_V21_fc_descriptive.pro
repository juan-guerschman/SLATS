...
;  months=['03','06','09','12']
  ...
  for m=0,3 do begin
    ...
    fname_plot = 'Descriptive.CSIRO_v21_month_'+years[y]+months[m]+'.ps'
    if (FILE_INFO(fname_plot)).exists eq 0 then begin
      PS_Start, fname_plot
        ...
        TVLCT, cgColor('grey', /Triple), 0
          cgImage, BytScl(rotate(CSIRO_v21_PV,7), Min=0, Max=1), Title='PV',$;, Palette=palette, $
        ...
        cgLoadCT, 16, /brewer
       TVLCT, cgColor('grey', /Triple), 0
          cgImage, BytScl(rotate(CSIRO_v21_NPV,7), Min=0, Max=1), Title='PV',$;, Palette=palette, $
            Position=[0.1, 0.1, 0.9, 0.9], /keep_aspect_ratio, /SAVE
         ...
         cgLoadCT, 13, /brewer
       TVLCT, cgColor('grey', /Triple), 0
          cgImage, BytScl(rotate(CSIRO_v21_BS,7), Min=0, Max=1), Title='PV',$;, Palette=palette, $
            Position=[0.1, 0.1, 0.9, 0.9], /keep_aspect_ratio, /SAVE
        ...
        cgHistoplot, CSIRO_v21_PV[where_OK], color='dark green', xtitle='PV'
        cgHistoplot, CSIRO_v21_NPV[where_OK], color='red', xtitle='NPV'
        cgHistoplot, CSIRO_v21_BS[where_OK], color='blue', xtitle='B'
